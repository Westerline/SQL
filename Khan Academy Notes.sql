...
(id Integer Identity(1,1) Primary Key, type Text, minutes Integer, Calories Integer, heart_rate Integer);
...
Example IN statements using AKPOS: 
Select * from B_Config 
...
Create Table drs_favorites
	(id Integer Identity(1,1) Primary Key, type Text, reason Text);

Insert Into drs_favorites (type, reason) Values ('biking', 'Improves endurance and flexibility.');
Insert Into drs_favorites (type, reason) Values ('hiking', 'Increases cardiovascular health.');
Insert Into drs_favorites (type, reason) Values ('Skateboarding', 'improves endurance and flexibility.');

Example Nested IN-Select Statement Using AKPOS:
Select * From B_Config Where Branch IN (Select ID From Branches Where ID = 102);
...
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('biking', 30, 115, 110);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('biking', 10, 45, 105);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('dancing', 15, 200, 120);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('dancing', 15, 165, 120);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('tree climbing', 30, 70, 90);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('tree climbing', 25, 72, 80);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('rowing', 30, 70, 90);
INSERT INTO exercise_logs(ExerciseType, minutes, calories, heart_rate) VALUES ('hiking', 60, 80, 85);
...
CREATE TABLE students (id INTEGER Identity(1,1) PRIMARY KEY,
    first_name TEXT,
    last_name TEXT,
    email TEXT,
    phone TEXT,
...
CREATE TABLE student_grades (id INTEGER Identity(1,1) PRIMARY KEY,
    student_id INTEGER,
    test TEXT,
    grade INTEGER);
...
CREATE TABLE student_projects (id INTEGER Identity(1,1) PRIMARY KEY,
    student_id INTEGER,
    title TEXT);
...
CREATE TABLE project_pairs (id INTEGER Identity(1,1) PRIMARY KEY,
    project1_id INTEGER,
    project2_id INTEGER);
...
Select One.Title,Two.title from project_pairs
